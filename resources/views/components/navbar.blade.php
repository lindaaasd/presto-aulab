    ...
    <div class="row align-items-center">
      <div class="nav-logo col-4 col-md-2 m-0 p-0 d-flex justify-content-center">
        <a class="navbar-brand" href="./"> 
          <img class="" width="80" height="80" src="https://assets.website-files.com/5ec440af4659932990a1020c/6126238e144f7970c00d7c57_60f17a27f09c3f9cecf7ef53_footer-avatar.png" alt="logo"> 
        </a>
      </div>
      <div class="nav-cat col-4 col-md-2 dropdown m-0 p-0 d-flex justify-content-end">
        <button class="btn category-btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
          Categorie
        </button>
